...
public partial class Report_PrintRACertifiedReport : System.Web.UI.Page
{
    ...
    public void GetValue()
    {
        try
        {
            decimal Sumbillcertifiedamt = 0, Sumservicetax = 0, SumServicetaxonfoc = 0, SumMobilizationAdvanceReceived = 0, SumSecuredAdvanceReceived = 0;
            ...
            for (int i = 0; i < Repeater1.Items.Count; i++)
            {
               ...
               // Label lblNetReceivable = (Label)Repeater1.Items[i].FindControl("lblNetReceivable");
                ...
                ViewState["SumAmtReceivable"] = SumAmtReceivable;
                //ViewState["SumNetReceivable"] = SumAmtReceivable;
        ...
        {
            string scripts = "alert('Report Print.');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
        }
    }
