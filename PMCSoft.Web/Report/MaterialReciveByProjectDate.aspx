<%@ Page Language="C#" MasterPageFile="~/ProjectMasterPage.master" AutoEventWireup="true" Inherits="PMCSoft.Web.Report.MaterialReciveByProjectDate" Codebehind="MaterialReciveByProjectDate.aspx.cs" %>
                ...
                <div id="content" style="width: 1100px;">
                    <div id="rightnow">
                        ...
                        <table style="width: 1090px;">
                            <%--<tr>
                                <td colspan="7" style="text-align: center; font-size: 15px; font-family: Cambria;">
