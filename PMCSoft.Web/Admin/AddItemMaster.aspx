<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.AddItemMaster" Codebehind="AddItemMaster.aspx.cs" %>
                                        ...
                                        <table style="width: 290px; vertical-align: top;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button ID="LnkAddNewUnit" runat="server" Text="+" OnClick="LnkAddNewUnit_Click">
                                                    </asp:Button>
                                                    <div style="display: none">
                                                                    ...
                                                                    <div id="Div2">
                                                                        ...
                                                                        <table style="width: 290px; vertical-align: top; background-color: #EFFBFB;">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtaddnewUnitName" runat="server" Width="200px" onkeyup="valid(this)"
                                                                                        onblur="valid(this)">
                                                                                    </asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2" style="text-align: center;">
                                                                                    <asp:Button ID="btnAddNewsave" runat="server" Text="Submit" OnClick="btnAddNewsave_Click" />
