<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.Home" Codebehind="Home.aspx.cs" %>
...
<div style=" background-color:#ECF5F8;border:none ; border:0px solid #ffffff">
    ...
    <asp:Panel ID="Panel1" runat="server" Style="display: none; border-color: Maroon;">
        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
            ...
            <ContentTemplate>
                <table style="width: 410px; background-color: #EFFBFB;">
                    <tr>
                        <td>
                            <div id="rightnow">
                                <h3 class="reallynow">
                                ...
                                <table style="width: 400px;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCircularNo" runat="server" Width="300px" onkeyup="valid(this)"
