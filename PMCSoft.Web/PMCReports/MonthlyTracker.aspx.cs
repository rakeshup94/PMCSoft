...
public partial class PMCReports_MonthlyTracker : System.Web.UI.Page
{
    ...
    void LoadToYears(ref DropDownList DrpToYears)
    {
        DrpToYears.Items.Clear();
        string Yrs = "";
        for (int i = 2014; i <= 2018; i++)
        {
            if (i.ToString().Length < 2)
    ...
    protected void BtnReport_Click(object sender, EventArgs e)
    {
        ...
        ht2.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht2.Add("@PlanYear", DDLTOYear.SelectedValue);
        ...
        ht3.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht3.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht4.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht4.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht5.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht5.Add("@PlanYear", DDLTOYear.SelectedValue);
        ...
        ht6.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht6.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht7.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht7.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht8.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht8.Add("@PlanYear", DDLTOYear.SelectedValue);
        ...
        ht9.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht9.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht10.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht10.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht11.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht11.Add("@PlanYear", DDLTOYear.SelectedValue);
        ...
        ht12.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht12.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht13.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht13.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht14.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht14.Add("@PlanYear", DDLTOYear.SelectedValue);
        ...
        ht15.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht15.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht16.Add("@PlanMonth", ddlMonth.SelectedValue);
        ht16.Add("@PlanYear", ddlSDaysYear.SelectedValue);
        ...
        ht17.Add("@PlanMonth", DDlToMonth.SelectedValue);
        ht17.Add("@PlanYear", DDLTOYear.SelectedValue);
    ...
    {
        string strURL = "PrintMonthTracker.aspx?";
        if (HttpContext.Current != null)
        {
            string strURLWithData = strURL + EncryptQueryString(string.Format("strPRJID={0}&strProjName={1}&strFrommonth={2}&strFromYear={3}&strTomonth={4}&strtoYear={5}",
                ddlProject.SelectedValue.ToString(), ddlProject.SelectedItem.Text, ddlMonth.SelectedValue.ToString(), ddlSDaysYear.SelectedValue.ToString(), DDlToMonth.SelectedValue.ToString(), DDLTOYear.SelectedValue.ToString()));
