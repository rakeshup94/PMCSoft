...
public partial class PMCReports_AddNewPlan : System.Web.UI.Page
{
    ...
    public void GetData()
    {
        ...
        DataTable dt1 = PMCApp.Get(ht1, "GetExpenditure");
        ...
        DataTable dt2 = PMCApp.Get(ht2, "GetConsumbles");
        ...
        DataTable dt3 = PMCApp.Get(ht3, "GetDirectExpenses");
        ...
        DataTable dt4 = PMCApp.Get(ht4, "GetHireChargesItemWise");
        ...
        DataTable dt6 = PMCApp.Get(ht6, "GetIndirectExpenses");
    ...
    protected void BtnIncomeSave_Click(object sender, EventArgs e)
    {
        ...
        if (txtIncomeParticulars.Text != "")
        {
            ...
            Hashtable ht1 = new Hashtable();
            DataTable dt1 = PMCApp.Get(ht1, "GetIncomedate");

            if (dt1.Rows.Count > 0)
            {
                RptIncome.DataSource = dt1;
                RptIncome.DataBind();
            }
        }
        else
    ...
    protected void BtnAddNewExpenditure_Click(object sender, EventArgs e)
    {
    ...
    protected void BtnExpenditure_Click(object sender, EventArgs e)
    {
        if (TxtExpenditure.Text != "")
        {
            ...
            ht.Add("@CompanyId", Session["CompID"].ToString());
            ht.Add("@ProjectId", ddlProject.SelectedValue);
            ht.Add("@Particular", TxtExpenditure.Text);
            ht.Add("@CreatedBy", Session["UserId"].ToString());
    ...
    protected void BtnExpenditureCancel_Click(object sender, EventArgs e)
    {
        ModalPopupExtender2.Hide();
    }
    protected void BtnAddNewCONSUMBLES_Click(object sender, EventArgs e)
    {
        ModalPopupExtenderConsumable.Show();
    ...
    {
        if (TxtConsumable.Text != "")
        {
            Hashtable ht = new Hashtable();
          
            ht.Add("@CompanyId", Session["CompID"].ToString());
            ht.Add("@ProjectId", ddlProject.SelectedValue);
            ht.Add("@Particular", TxtConsumable.Text);
            ht.Add("@CreatedBy", Session["UserId"].ToString());
    ...
    protected void BtnConsumableCancel_Click(object sender, EventArgs e)
    {
        ModalPopupExtenderConsumable.Hide();

    }
    protected void BtnAddNewDirectExpense_Click(object sender, EventArgs e)
    {
        ModalPopupExtender3.Show();

    }
    protected void BtnDirectExpensesSave_Click(object sender, EventArgs e)
    {
        if (TxtDirectExpenses.Text != "")
        {
            ...
            ht.Add("@CompanyId", Session["CompID"].ToString());
            ht.Add("@ProjectId", ddlProject.SelectedValue);
            ht.Add("@Particular", TxtDirectExpenses.Text);
            ht.Add("@CreatedBy", Session["UserId"].ToString());

            PMCApp.Get(ht, "InsertDirectExpenses");
            string scripts = "alert('Insert Successfully .');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
            TxtDirectExpenses.Text = "";
            Hashtable ht3 = new Hashtable();
            DataTable dt3 = PMCApp.Get(ht3, "GetDirectExpenses");
    ...
    protected void BtnDirectExpensesCancel_Click(object sender, EventArgs e)
    {
        ModalPopupExtender3.Hide();

    }
    protected void BtnAddNewHireCharges_Click(object sender, EventArgs e)
    {
        ModalPopupExtender4.Show();

    }

    protected void BtnHireChargesSave_Click(object sender, EventArgs e)
    {
        if (TxtHireCharges.Text != "")
        {
            ...
            ht.Add("@CompanyId", Session["CompID"].ToString());
            ht.Add("@ProjectId", ddlProject.SelectedValue);
            ht.Add("@Particular", TxtHireCharges.Text);
            ht.Add("@CreatedBy", Session["UserId"].ToString());
    ...
    protected void btnHireChargesCancel_Click(object sender, EventArgs e)
    {
        ModalPopupExtender4.Hide();
    }
    protected void BtnAddNewINDIRECTEXPENSES_Click(object sender, EventArgs e)
    {
        ModalPopupExtender5.Show();

    }
    protected void BtnIndirectExpensesSave_Click(object sender, EventArgs e)
    {
        if (TxtIndirectExpenses.Text != "")
        {
            Hashtable ht = new Hashtable();
           
            ht.Add("@CompanyId", Session["CompID"].ToString());
            ht.Add("@ProjectId", ddlProject.SelectedValue);
            ht.Add("@Particular", TxtIndirectExpenses.Text);
            ht.Add("@CreatedBy", Session["UserId"].ToString());
            PMCApp.Get(ht, "InsertIndirectExpenses");
            string scripts = "alert('Insert Successfully .');";
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
            TxtIndirectExpenses.Text = "";
            Hashtable ht6 = new Hashtable();
            DataTable dt6 = PMCApp.Get(ht6, "GetIndirectExpenses");
    ...
    protected void btnIndirectExpensesCancel_Click(object sender, EventArgs e)
    {
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int j = 0; j < RptIncome.Items.Count; j++)
            {
                ...
                TextBox txtpincome = (TextBox)RptIncome.Items[j].FindControl("txtpincome");
                if (txtpincome.Text == "")
                {
                    check = 1;
                    break;
            ...
            for (int j = 0; j < RptExpenditure.Items.Count; j++)
            {
                ...
                TextBox txtPexpenditure = (TextBox)RptExpenditure.Items[j].FindControl("txtPexpenditure");
                if (txtPexpenditure.Text == "")
                {
                    check1 = 1;
                    break;
                }
            ...
            for (int j = 0; j < RptConsumbles.Items.Count; j++)
            {
                ...
                TextBox txtPCONSUMBLES = (TextBox)RptConsumbles.Items[j].FindControl("txtPCONSUMBLES");
                if (txtPCONSUMBLES.Text == "")
                {
                    check2 = 1;
                    break;
                }
            ...
            for (int j = 0; j < RptDirectExpenses.Items.Count; j++)
            {
                ...
                TextBox txtPDIRECTEXPENSES = (TextBox)RptDirectExpenses.Items[j].FindControl("txtPDIRECTEXPENSES");
                if (txtPDIRECTEXPENSES.Text == "")
                {
                    check3 = 1;
                    break;
                }
            ...
            for (int j = 0; j < RptHirecharges.Items.Count; j++)
            {
                ...
                TextBox txtPHireCharge = (TextBox)RptHirecharges.Items[j].FindControl("txtPHireCharge");
                if (txtPHireCharge.Text == "")
                {
                    check4 = 1;
                    break;
                }
            ...
            for (int j = 0; j < RptIndirectExpenses.Items.Count; j++)
            {
                ...
                TextBox txtPIndirctExpenses = (TextBox)RptIndirectExpenses.Items[j].FindControl("txtPIndirctExpenses");
                if (txtPIndirctExpenses.Text == "")
                {
                    check5 = 1;
                    break;
                }
            ...
            DataTable Dtcheck = PMCApp.Get(htcheck, "CheckPlanMonthandYearWise");
                    ...
                    if (txtDate.Text != "")
                    {
                        if (ddlMonth.SelectedValue != "-1")
                        {
                            if (ddlSDaysYear.SelectedValue != "-1")
                            {
                                if (check == 0)
                                {
                                    if (check1 == 0)
                                    {
                                        if (check2 == 0)
                                        {
                                            if (check3 == 0)
                                            {
                                                if (check4 == 0)
                                                {
                                                    if (check4 == 0)
                                                    {
                                                        ...
                                                        for (int k = 0; k < RptIncome.Items.Count; k++)
                                                        {
                                                            HiddenField hdnIncomeParticularID = (HiddenField)RptIncome.Items[k].FindControl("hdnIncomeParticularID");
                                                            Label lblIncome = (Label)RptIncome.Items[k].FindControl("lblIncome");
                                                            TextBox txtpincome = (TextBox)RptIncome.Items[k].FindControl("txtpincome");
                                                            ...
                                                            htincome.Add("@PlanDate", txtDate.Text);
                                                            htincome.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            htincome.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            htincome.Add("@ParticularsId", hdnIncomeParticularID.Value);
                                                            htincome.Add("@ParticularsName", lblIncome.Text);
                                                            htincome.Add("@PlanValue", txtpincome.Text);
                                                            htincome.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(htincome, "InsertPlan");
                                                            SumIncome = SumIncome + Math.Round(Convert.ToDecimal(txtpincome.Text), 2);
                                                            ViewState["SumIncome"] = SumIncome;
                                                        }
                                                        

                                                      
                                                        for (int k = 0; k < RptExpenditure.Items.Count; k++)
                                                        {
                                                            HiddenField hdnEXPENDITUREParticularID = (HiddenField)RptExpenditure.Items[k].FindControl("hdnEXPENDITUREParticularID");
                                                            Label lblExpenditure = (Label)RptExpenditure.Items[k].FindControl("lblExpenditure");
                                                            TextBox txtPexpenditure = (TextBox)RptExpenditure.Items[k].FindControl("txtPexpenditure");
                                                            Hashtable HtExpen = new Hashtable();
                                                          
                                                            HtExpen.Add("@CompanyId", Session["CompID"].ToString());
                                                            HtExpen.Add("@ProjectId", ddlProject.SelectedValue);
                                                            HtExpen.Add("@PlanDate", txtDate.Text);
                                                            HtExpen.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            HtExpen.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            HtExpen.Add("@ParticularsId", hdnEXPENDITUREParticularID.Value);
                                                            HtExpen.Add("@ParticularsName", lblExpenditure.Text);
                                                            HtExpen.Add("@PlanValue", txtPexpenditure.Text);
                                                            HtExpen.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(HtExpen, "InsertPlan");

                                                        }
                                                     

                                                       
                                                        for (int k = 0; k < RptConsumbles.Items.Count; k++)
                                                        {
                                                            HiddenField hdnCONSUMBLESParticularID = (HiddenField)RptConsumbles.Items[k].FindControl("hdnCONSUMBLESParticularID");
                                                            Label lblCONSUMBLES = (Label)RptConsumbles.Items[k].FindControl("lblCONSUMBLES");
                                                            TextBox txtPCONSUMBLES = (TextBox)RptConsumbles.Items[k].FindControl("txtPCONSUMBLES");
                                                            Hashtable HtConSum = new Hashtable();
                                                            
                                                            HtConSum.Add("@CompanyId", Session["CompID"].ToString());
                                                            HtConSum.Add("@ProjectId", ddlProject.SelectedValue);
                                                            HtConSum.Add("@PlanDate", txtDate.Text);
                                                            HtConSum.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            HtConSum.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            HtConSum.Add("@ParticularsId", hdnCONSUMBLESParticularID.Value);
                                                            HtConSum.Add("@ParticularsName", lblCONSUMBLES.Text);
                                                            HtConSum.Add("@PlanValue", txtPCONSUMBLES.Text);
                                                            HtConSum.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(HtConSum, "InsertPlan");

                                                        }
                                                      
                                                       
                                                        for (int k = 0; k < RptDirectExpenses.Items.Count; k++)
                                                        {
                                                            HiddenField hdnDIRECTEXPENSESParticularID = (HiddenField)RptDirectExpenses.Items[k].FindControl("hdnDIRECTEXPENSESParticularID");
                                                            Label lblDIRECTEXPENSES = (Label)RptDirectExpenses.Items[k].FindControl("lblDIRECTEXPENSES");
                                                            TextBox txtPDIRECTEXPENSES = (TextBox)RptDirectExpenses.Items[k].FindControl("txtPDIRECTEXPENSES");
                                                            Hashtable HtDirect = new Hashtable();
                                                           
                                                            HtDirect.Add("@CompanyId", Session["CompID"].ToString());
                                                            HtDirect.Add("@ProjectId", ddlProject.SelectedValue);
                                                            HtDirect.Add("@PlanDate", txtDate.Text);
                                                            HtDirect.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            HtDirect.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            HtDirect.Add("@ParticularsId", hdnDIRECTEXPENSESParticularID.Value);
                                                            HtDirect.Add("@ParticularsName", lblDIRECTEXPENSES.Text);
                                                            HtDirect.Add("@PlanValue", txtPDIRECTEXPENSES.Text);
                                                            HtDirect.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(HtDirect, "InsertPlan");


                                                        }
                                                     
                                                       
                                                        for (int k = 0; k < RptHirecharges.Items.Count; k++)
                                                        {
                                                            HiddenField hdnHIRECHARGESParticularID = (HiddenField)RptHirecharges.Items[k].FindControl("hdnHIRECHARGESParticularID");

                                                            Label lblHireCharge = (Label)RptHirecharges.Items[k].FindControl("lblHireCharge");
                                                            TextBox txtPHireCharge = (TextBox)RptHirecharges.Items[k].FindControl("txtPHireCharge");
                                                            Hashtable HtHire = new Hashtable();
                                                          
                                                            HtHire.Add("@CompanyId", Session["CompID"].ToString());
                                                            HtHire.Add("@ProjectId", ddlProject.SelectedValue);
                                                            HtHire.Add("@PlanDate", txtDate.Text);
                                                            HtHire.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            HtHire.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            HtHire.Add("@ParticularsId", hdnHIRECHARGESParticularID.Value);
                                                            HtHire.Add("@ParticularsName", lblHireCharge.Text);
                                                            HtHire.Add("@PlanValue", txtPHireCharge.Text);
                                                            HtHire.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(HtHire, "InsertPlan");

                                                        }
                                                       
                                                      
                                                        for (int k = 0; k < RptIndirectExpenses.Items.Count; k++)
                                                        {
                                                            HiddenField hdnIncomeParticularID = (HiddenField)RptIndirectExpenses.Items[k].FindControl("hdnIncomeParticularID");
                                                            Label lblIndirctExpenses = (Label)RptIndirectExpenses.Items[k].FindControl("lblIndirctExpenses");
                                                            TextBox txtPIndirctExpenses = (TextBox)RptIndirectExpenses.Items[k].FindControl("txtPIndirctExpenses");
                                                            Hashtable HtIndierct = new Hashtable();
                                                          
                                                            HtIndierct.Add("@CompanyId", Session["CompID"].ToString());
                                                            HtIndierct.Add("@ProjectId", ddlProject.SelectedValue);
                                                            HtIndierct.Add("@PlanDate", txtDate.Text);
                                                            HtIndierct.Add("@PlanMonth", ddlMonth.SelectedValue);
                                                            HtIndierct.Add("@PlanYear", ddlSDaysYear.SelectedValue);
                                                            HtIndierct.Add("@ParticularsId", hdnIncomeParticularID.Value);
                                                            HtIndierct.Add("@ParticularsName", lblIndirctExpenses.Text);
                                                            HtIndierct.Add("@PlanValue", txtPIndirctExpenses.Text);
                                                            HtIndierct.Add("@CreatedBy", Session["UserId"].ToString());
                                                            PMCApp.Get(HtIndierct, "InsertPlan");
                                                            string scripts = "alert('Insert Successfully.');";
                                                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                                           GetData();
                                                        }
                                                    ...
                                                    {
                                                        string scripts = "alert('Kindly Fill Particulars Indirct Expenses Plane Value. ');";
                                                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                                    }
                                                }
                                                else
                                                {
                                                    string scripts = "alert('Kindly Fill Particulars Hire Charges(Item Wise) Plane Value. ');";
                                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                                }
                                            ...
                                            {
                                                string scripts = "alert('Kindly Fill Particulars Direct Expenses Plane Value. ');";
                                                ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                            }
                                        ...
                                        {
                                            string scripts = "alert('Kindly Fill Particulars Consumbles Plane Value. ');";
                                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                        }
                                    ...
                                    {
                                        string scripts = "alert('Kindly Fill Particulars Expenditure Plane Value. ');";
                                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                    }
                                ...
                                {
                                    string scripts = "alert('Kindly Fill Particulars Income Plane Value. ');";
                                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                                }
                            }
