<%@ Page Language="C#" AutoEventWireup="true" Inherits="PMCReports_PrintMonthTracker" Codebehind="PrintMonthTracker.aspx.cs" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Repeater ID="Repeater2" runat="server">
                                                        <HeaderTemplate>
                                                            <table style="margin-left: -5px; border: 1px solid black; border-collapse: collapse;">
                                                                <tr>
                                                                    <td colspan="6" style="text-align: center; border: 1px solid black; background-color: #D8D8D8;
                                                                        font-weight: bold;">
                                                                        Current  Month
