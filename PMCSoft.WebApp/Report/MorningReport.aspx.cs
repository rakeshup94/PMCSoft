...
public partial class Report_MorningReport : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        try
        {
            DT = PMCApp.GetDataTableWithTwoStringValue("GetMorningReport", ddlProject.SelectedValue.ToString(), txtDate.Text);
            if (DT.Rows.Count > 0)
            {
                Panel1.Visible = true;
