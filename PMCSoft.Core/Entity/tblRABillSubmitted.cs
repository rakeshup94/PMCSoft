namespace PMCSoft.Core.Entity
{
    ...
    [Table("tblRABillSubmitted")]
    public partial class tblRABillSubmitted
    {
        [Key]
        ...
        public DateTime? BillCertificationDate { get; set; }

        public decimal? BillCertifiedAmount { get; set; }
