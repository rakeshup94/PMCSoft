$(function () {
    ...
    var pathname = location.pathname + '.aspx'
    $('.navbar-static-side').find('a[href="' + pathname + '"]').closest('.navbar-static-side').addClass('collapse show');
    $('.navbar-static-side').find('a[href="' + pathname + '"]').closest('li').addClass('active');
    $('.navbar-static-side').find('a[href="' + pathname + '"]').closest('.navbar-static-side').addClass('collapse show');
    $('.nav-second-level').find('a[href="' + pathname + location.search + '"]').parents('li').addClass('active');
    $('.nav-second-level').find('a[href="' + pathname + location.search + '"]').closest('.nav-second-level').addClass('collapse show');
    $('.nav-second-level').find('a[href="' + pathname + location.search + '"]').closest('li').addClass('active');
    $('.nav-second-level').find('a[href="' + pathname + location.search + '"]').closest('.nav-second-level').addClass('collapse show');
    $('.nav-third-level').find('a[href="' + pathname + '"]').closest('.nav-third-level').addClass('collapse show');
    $('.nav-third-level').find('a[href="' + pathname + '"]').closest('li').addClass('active');
    $('.nav-third-level').find('a[href="' + pathname + '"]').closest('.nav-third-level').addClass('collapse show');
    $('.nav-forth-level').find('a[href="' + pathname + '"]').closest('.nav-forth-level').addClass('collapse show');
    $('.nav-forth-level').find('a[href="' + pathname + '"]').closest('li').addClass('active');
    $('.nav-forth-level').find('a[href="' + pathname + '"]').closest('.nav-forth-level').addClass('collapse show');
    ...
    $("button[class = 'navbar-toggle']").click(function () {
        ...
        if ($('#sidebar .sidebar-collapse').css("display") == "block") {
            $('#sidebar .sidebar-collapse').css('display', 'none');
        }
        else if ($('#sidebar .sidebar-collapse').css("display") == "none") {
            $('#sidebar .sidebar-collapse').css('display', 'block');
        }
