<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.AdminReports.RACertifiedReport" Codebehind="RACertifiedReport.aspx.cs" %>
                                                        ...
                                                        <HeaderTemplate>
                                                            <div class="row"  style="width: 1100px; border: 1px solid black; border-collapse: collapse;">
                                                                <div class="row" >
                                                                    ...
                                                                    <div class="col-lg-4"    style="text-align: center; width: 80px; border: 1px solid black;
                                                                        background-color: #D8D8D8;">
                                                                        Deduction
                                                                    </div>
                                                                    <div class="col-lg-4"  rowspan="2" style="width: 100px; text-align: center; border: 1px solid black;
