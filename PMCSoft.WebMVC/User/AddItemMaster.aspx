<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.User.AddItemMaster"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 offset-sm-4">
                                <div class="mb-3">
                                    Group Name 
                                    <asp:DropDownList CssClass="form-select" ID="ddlitemGropgrid" runat="server" AutoPostBack="True"
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton CssClass="btn btn-default btn-xs" ID="lnkEmpEdit" runat="server"
                                                    Text="Edit" CommandName="EditDetail"><i class='fa fa-edit mediumtxt'></i> </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    ...
                                    Group Name
                                          ...
                                          <div class="input-group">
                                              ...
                                              <div class="input-group-addon">
                                                  ...
                                                  <asp:Button CssClass="btn btn-primary btn-square" ID="LnkAddNewGroupName" runat="server"
                                                      Text="+" OnClick="LnkAddNewGroupName_Click"></asp:Button>
                                                  <div style="display: none">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                   ...
                                   <div class="input-group">
                                       ...
                                       <div class="input-group-addon">
                                           <asp:Button CssClass="btn btn-primary btn-square" ID="LnkAddNewUnit" runat="server"
                                               Text="+"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    Make
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="txtItemMake" runat="server" onblur="valid(this)"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    Part No.
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="txtItemPartNo" runat="server" onblur="valid(this)"
                                                        onkeyup="valid(this)"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:LinkButton CssClass="btn btn-lg btn-red" ID="BtnAddNewCancel" OnClick="BtnAddNewCancel_Click"
                                runat="server"><i class='fa fa-times start-0'></i> Close</asp:LinkButton>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <asp:Button CssClass="btn btn-primary btn-square" ID="btnAddNewGroupname" runat="server"
                                        Text="Submit" OnClick="btnAddNewGroupname_Click" />
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:LinkButton CssClass="btn btn-lg btn-red" ID="BtnCancelAddNewGroupName" OnClick="BtnCancelAddNewGroupName_Click"
                                runat="server"><i class='fa fa-times start-0'></i> Close</asp:LinkButton>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <asp:Button CssClass="btn-close" runat="server"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <asp:Button CssClass="btn btn-primary btn-square" ID="EditSubmit" runat="server"
                                        Text="Submit" OnClick="EditSubmit_Click" />

                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <asp:LinkButton CssClass="btn btn-lg btn-red" ID="EditCancel" OnClick="EditCancel_Click"
                                runat="server"><i class='fa fa-times start-0'></i> Close</asp:LinkButton>
                        </div>
