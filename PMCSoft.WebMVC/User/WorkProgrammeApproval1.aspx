                                                ...
                                                <div class="col-lg-4">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row" style="width: 390;">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <asp:Button CssClass="btn btn-primary btn-square" ID="btnApproved" runat="server"
                                                                        Text="Submit" OnClick="btnApproved_Click" />
                                                                    <asp:Button CssClass="btn btn-primary btn-square" ID="btnApprovedCancel" runat="server"
