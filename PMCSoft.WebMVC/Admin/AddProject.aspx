            ...
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Project Particulars
                                                </td>
                                                <td>Availibility Of Documents (Y/N)
                                                </td>
                                                <td>Insurance/Licenses (Y/N) &amp; Date of Validity
                                                </td>
                                                <td>Facilities Provided By Clients (Y/N) and whether chargeable from Co. or not
                                                </td>
                                                <td>Other Deposit / Bonds / Guarantees
                                                </td>
                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col-lg-4" style="font-weight: bold; width: 80px; background-color: #D9EAED;
                                    color: #202020; border: .5px solid #D9EAED;">
                                    Project ID
                                </div>
                                <div class="col-lg-4" style="font-weight: bold; background-color: #D9EAED; color: #202020;
                                    vertical-align: top; border: .5px solid #D9EAED;">
                                    <asp:TextBox CssClass="form-control" ID="txtProjectID" runat="server" Width="100px"
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 920px; border: 1px solid #D9EAED; border-collapse: collapse;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtProjectName" runat="server" Width="550px"
                                                                onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtLocation" runat="server" Width="550px"
                                                                onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtDateOfAward" runat="server" Width="550px"
                                                                onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtLOINo" runat="server" Width="550px" onkeyup="valid(this)"
                                                                onblur="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtLOIDate" runat="server" Width="550px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtNameOfRegion" runat="server" Width="550px"
                                                                onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtProjectInchargeName" runat="server" Width="390px"
                                                                onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                            <div class="row" style="width: 550px; vertical-align: top; border: .5px solid #D9EAED;
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtStipulatedDateOfStart" runat="server"
                                                                Width="550px" onkeyup="valid(this)"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <asp:TextBox CssClass="form-control" ID="txtActualDateOfStart" runat="server" Width="550px"
                                                                onkeyup="valid(this)"
                                        ...
                                        <cc1:TabPanel ID="Tab2" runat="server" TabIndex="1">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView2" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab3" runat="server" TabIndex="2">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView3" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab4" runat="server" TabIndex="3">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView4" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab5" runat="server" TabIndex="4">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView5" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab6" runat="server" TabIndex="5">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView6" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab7" runat="server" TabIndex="6">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView7" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                                        ...
                                        <cc1:TabPanel ID="Tab8" runat="server" TabIndex="7">
                                            ...
                                            <ContentTemplate>
                                                <div class="row" style="width: 910px;">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <asp:GridView CssClass="table table-striped" ID="GridView8" runat="server" AutoGenerateColumns="false"
                                                                Width="910px">
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="S.No">
                                                                        <ItemTemplate>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <asp:Button CssClass="btn btn-primary" ID="btnParticularsSubmit" runat="server" Text="Submit"
