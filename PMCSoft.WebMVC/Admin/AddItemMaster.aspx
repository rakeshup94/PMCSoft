<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.AddItemMaster" Codebehind="AddItemMaster.aspx.cs" %>
                                        ...
                                        <div class="row"  style="width: 290px; vertical-align: top;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Button CssClass="btn btn-primary" ID="LnkAddNewUnit" runat="server" Text="+" OnClick="LnkAddNewUnit_Click">
                                                    </asp:Button>
                                                    <div style="display: none">
                                                                ...
                                                                <td>
                                                                    <div id="Div2">
                                                                        ...
                                                                        <div class="row"  style="width: 290px; vertical-align: top; background-color: #EFFBFB;">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="2" style="text-align: center;">
                                                                                    <asp:Button CssClass="btn btn-primary" ID="btnAddNewsave" runat="server" Text="Submit" OnClick="btnAddNewsave_Click" />
                                                                                    <asp:Button CssClass="btn btn-primary" ID="BtnAddNewCancel" runat="server" Text="Cancel" OnClick="BtnAddNewCancel_Click" />
                                                                                </td>
                                                                            </tr>
                                                                          </div>
                                                                    </div>
