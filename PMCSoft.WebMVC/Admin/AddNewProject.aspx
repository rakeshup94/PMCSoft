<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.AddNewProject" Codebehind="AddNewProject.aspx.cs" %>
                        ...
                        <table style="width: 925px; vertical-align: top;">
                            <tr style="vertical-align: top;">
                                ...
                                <td style="font-weight: bold; background-color: #D9EAED; color: #202020; vertical-align: top;">
                                    <asp:TextBox ID="txtProjectID" runat="server" Width="100px" Enabled="false" ReadOnly="true"
                                                                ...
                                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="890px">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Clause">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtClause" runat="server" onkeyup="valid(this)" onblur="valid(this)"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Subsequent Amendments">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtAmendments" runat="server" onkeyup="valid(this)" onblur="valid(this)">
                                                                                </asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                                                            ...
                                                            <td>
                                                                <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="false" Width="890px">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Clause">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox ID="txtClause" runat="server" onkeyup="valid(this)" onblur="valid(this)">
                                                                                </asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    <asp:Button ID="btnParticularsSubmit" runat="server" Text="Submit" OnClick="btnParticularsSubmit_Click" />
