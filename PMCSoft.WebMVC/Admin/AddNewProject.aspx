<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.AddNewProject" Codebehind="AddNewProject.aspx.cs" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row"  style="width: 925px; vertical-align: top;">
                            <div class="row"  style="vertical-align: top;">
                                <div class="col-lg-4"  style="font-weight: bold; width: 80px; background-color: #D9EAED; color: #202020;">
                                    Project Id
                                </div>
                                <div class="col-lg-4"  style="font-weight: bold; background-color: #D9EAED; color: #202020; vertical-align: top;">
                                    <asp:TextBox CssClass="form-control" ID="txtProjectID" runat="server" Width="100px" Enabled="false" ReadOnly="true"
                                                                ...
                                                                <asp:GridView CssClass="table table-striped"  ID="GridView1" runat="server" AutoGenerateColumns="false" Width="890px">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Clause">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox CssClass="form-control" ID="txtClause" runat="server" onkeyup="valid(this)" onblur="valid(this)"></asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                                                                        <asp:TemplateField HeaderText="Subsequent Amendments">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox CssClass="form-control" ID="txtAmendments" runat="server" onkeyup="valid(this)" onblur="valid(this)">
                                                                                </asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                                                            ...
                                                            <div class="col-lg-4" >
                                                                <asp:GridView CssClass="table table-striped"  ID="GridView8" runat="server" AutoGenerateColumns="false" Width="890px">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Clause">
                                                                            <ItemTemplate>
                                                                                <asp:TextBox CssClass="form-control" ID="txtClause" runat="server" onkeyup="valid(this)" onblur="valid(this)">
                                                                                </asp:TextBox>
                                                                            </ItemTemplate>
                                                                            <ItemStyle Width="100px" VerticalAlign="Top" BorderColor="#D9EAED" />
                                                                        </asp:TemplateField>
                            ...
                            <div class="row" >
                                <div class="col-lg-4"    >
                                    <asp:Button CssClass="btn btn-primary" ID="btnParticularsSubmit" runat="server" Text="Submit" OnClick="btnParticularsSubmit_Click" />
