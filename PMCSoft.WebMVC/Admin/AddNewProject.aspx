        ...
        <ContentTemplate>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    Project Id
                                    <asp:TextBox CssClass="form-control" ID="txtProjectID" runat="server" Enabled="false"
                                        ReadOnly="true" onkeyup="valid(this)" onblur="valid(this)"></asp:TextBox>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <button class="nav-link active bi-text-left" id="v-pills-project-tab" data-bs-toggle="pill" data-bs-target="#v-pills-project"
                                    type="button" role="tab" aria-controls="v-pills-project">
                                    Project Particulars
                                </button>
                                <button class="nav-link" id="v-pills-document-tab" data-bs-toggle="pill" data-bs-target="#v-pills-document"
                                    type="button" role="tab" aria-controls="v-pills-document">
                               Client Detail
                                </button>
                                <button class="nav-link" id="v-pills-insurance-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-insurance"
                                    type="button" role="tab" aria-controls="v-pills-insurance">
                           PMC/Project Manager Detail
                                </button>
                                <button class="nav-link" id="v-pills-facilities-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-facilities"
                                    type="button" role="tab" aria-controls="v-pills-facilities">
             Architect Detail
                                </button>
                                <button class="nav-link" id="v-pills-deposit-tab" data-bs-toggle="pill" data-bs-target="#v-pills-deposit"
                                    type="button" role="tab" aria-controls="v-pills-deposit">
                          Structural Consultant Detail
                                </button>
                                <button class="nav-link" id="v-pills-mobilization-tab" data-bs-toggle="pill"
                                    data-bs-target="#v-pills-mobilization"
                                    type="button" role="tab" aria-controls="v-pills-mobilization">
                                . Mechanical Detail
                                </button>
                                <button class="nav-link" id="v-pills-billing-tab" data-bs-toggle="pill" data-bs-target="#v-pills-billing"
                                    type="button" role="tab" aria-controls="v-pills-billing">
                            Electrical Detail
                                </button>
                                ...
                                <cc1:AccordionPane ID="AccordionPane1" runat="server">
                                    ...
                                    <Content>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">8.      Client Detail</div>
                                            <div class="card-body">
                                                <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header">9.  PMC/Project Manager Detail</div>
                                            <div class="card-body">
                                                <div class="row">
            ...
            <asp:TextBox CssClass="form-control" ID="txtProjectManagerEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">10 .       Architect Detail</div>
                                            <div class="card-body">
            ...
            <asp:TextBox CssClass="form-control" ID="txtArchitectEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">11     Structural Consultant Detail</div>
                                            <div class="card-body">
                                                <div class="row">
            ...
            <asp:TextBox CssClass="form-control" ID="txtStructuralEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">12.             Mechanical Detail</div>
                                            <div class="card-body">
            ...
            <asp:TextBox CssClass="form-control" ID="txtMechanicalEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">13  Electrical Detail</div>
                                            <div class="card-body">
                                                <div class="row">
            ...
            <asp:TextBox CssClass="form-control" ID="txtElectricalEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-title">14       Plumbing Consultant Detail</div>
                                            <div class="card-body">
                                                <div class="row">
