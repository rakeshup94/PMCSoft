                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        ...
                                        <asp:TextBox CssClass="form-control" ID="txtProjectID" runat="server" Enabled="false"
                                            ReadOnly="true" Placeholder="Project Id" onkeyup="valid(this)" onblur="valid(this)"></asp:TextBox>
                                        <div class="input-group-addon">
                                            <asp:LinkButton ID="ImgRefresh" CssClass="mediumtxt ps-3" runat="server" Text="<i class='fa fa-refresh  text-green'></i>"
