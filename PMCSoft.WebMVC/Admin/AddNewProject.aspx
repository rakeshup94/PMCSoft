    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-12 d-block d-sm-none">
                                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                                    <button class="nav-link active text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Project"
                                        type="button">
                                        Project Particulars
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Availibility"
                                        type="button">
                                        Availibility Of Documents (Y/N)
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Insurance"
                                        type="button">
                                        Insurance/Licenses (Y/N) &amp; Date of Validity
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Facilities"
                                        type="button">
                                        Facilities Provided By Clients (Y/N) and whether chargeable from Co. or not
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-OtherDeposit"
                                        type="button">
                                        Other Deposit / Bonds / Guarantees
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Mobilization"
                                        type="button">
                                        Mobilization Advance
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Billing"
                                        type="button">
                                        Billing
                                    </button>
                                    <button class="nav-link  text-start" data-bs-toggle="pill" data-bs-target="#v-mpills-Payment"
                                        type="button">
                                        Payment Terms
                                    </button>
                                </div>
                            ...
                            <div class="col-lg-9 pe-sm-0">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="v-mpills-Project" role="tabpanel">
            ...
            <asp:TextBox CssClass="form-control" ID="txtPlumbingEmail" runat="server" placeholder="Email Id"></asp:TextBox>
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Availibility" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Insurance" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Facilities" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-OtherDeposit" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Mobilization" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Billing" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                    ...
                                    <div class="tab-pane fade show" id="v-mpills-Payment" role="tabpanel">
