                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <button class="nav-link text-lg-start active" data-bs-toggle="pill" data-bs-target="#v-pills-Project"
                                    type="button" role="tab">
                                    Project Particulars
                                </button>
                                <button class="nav-link text-lg-start" data-bs-toggle="pill" data-bs-target="#v-pills-Client"
                                    type="button" role="tab">
                                    Client Detail
                                </button>
                                <button class="nav-link text-lg-start" data-bs-toggle="pill"
                                ...
                                <button class="nav-link text-lg-start" data-bs-toggle="pill" data-bs-target="#v-pills-Structural"
                                    type="button" role="tab">
                                ...
                                <button class="nav-link text-lg-start" data-bs-toggle="pill" data-bs-target="#v-pills-Electrical"
                                    type="button" role="tab">
                                    Electrical Detail
                                </button>
                                <button class="nav-link text-lg-start" data-bs-toggle="pill" data-bs-target="#v-pills-Plumbing"
                                    type="button" role="tab">
                                    Plumbing Consultant Detail
                                </button>
                                <button class="nav-link text-lg-start" data-bs-toggle="pill" data-bs-target="#v-pills-Others"
                                    type="button" role="tab">
                                    Others
                                </button>
                            </div>
