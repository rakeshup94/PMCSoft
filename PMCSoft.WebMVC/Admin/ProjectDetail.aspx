<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.ProjectDetail"
    CodeBehind="ProjectDetail.aspx.cs" %>
                ...
                <div class="card"  style="width: 935px;">
                    <div class="card-body">
                        ...
                        <div class="row" style="width: 925px; vertical-align: top;">
                                        ...
                                        <cc1:Accordion ID="Accordion1" runat="server" SelectedIndex="0" HeaderCssClass="accordionHeader"
                                            ...
                                            <Panes>
                                                    ...
                                                    <Content>
                                                        <div class="row" style="width: 900px; border: 1px solid #D9EAED; border-collapse: collapse;">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtProjectAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtLocationAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtDateOfAwardAmendments" runat="server"
                                                                        Width="160px" onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtLOINoAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtLOIDateAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtClientName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlClientCountry" runat="server" Width="175px"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtClientMobileNo" runat="server" Width="170px"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtClientFaxNo" runat="server" Width="170px"
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center; vertical-align: top;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtClientAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtProjectManagerName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlProjectManagerCountry" runat="server"
                                                                                    Width="175px" OnSelectedIndexChanged="ddlProjectManagerCountry_SelectedIndexChanged"
                                                                                    AutoPostBack="true">
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtProjectManagerFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtArchitectName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlArchitectCountry" runat="server"
                                                                                    Width="175px" OnSelectedIndexChanged="ddlArchitectCountry_SelectedIndexChanged"
                                                                                    AutoPostBack="true">
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtArchitectMobileNo" runat="server" Width="170px"
                                                                                    MaxLength="10"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Mobile No."></asp:TextBox>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtArchitectFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11" onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Fax No."></asp:TextBox>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center; vertical-align: top;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtArchitectAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtStructuralConsultantName" runat="server"
                                                                                    Width="170px" onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                                Address
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtStructuralFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Fax No."></asp:TextBox>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtMechanicalName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlMechanicalCountry" runat="server"
                                                                                    Width="175px" OnSelectedIndexChanged="ddlMechanicalCountry_SelectedIndexChanged"
                                                                                    AutoPostBack="true">
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtMechanicalMobileNo" runat="server" Width="170px"
                                                                                    MaxLength="10"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Mobile No."></asp:TextBox>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtMechanicalFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Fax No."></asp:TextBox>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtElectricalName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlElectricalCountry" runat="server"
                                                                                    Width="175px" OnSelectedIndexChanged="ddlElectricalCountry_SelectedIndexChanged"
                                                                                    AutoPostBack="true">
                                                                                </asp:DropDownList>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtElectricalZipCode" runat="server" Width="170px"
                                                                                    MaxLength="6"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Zip Code"></asp:TextBox>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtElectricalMobileNo" runat="server" Width="170px"
                                                                                    MaxLength="10"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Mobile No."></asp:TextBox>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtElectricalFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Fax No."></asp:TextBox>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; vertical-align: top;">
                                                                    <div class="row" style="width: 540px; vertical-align: top; border: .5px solid #D9EAED;
                                                                        ...
                                                                        <div class="row" style="vertical-align: top;">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtPlumbingName" runat="server" Width="170px"
                                                                                    onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Name"></asp:TextBox>
                                                                            </div>
                                                                            <div class="col-lg-4" style="vertical-align: top; width: 80px; border: .5px solid #D9EAED;">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:DropDownList CssClass="form-select" ID="ddlPlumbingCountry" runat="server" Width="175px"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtPlumbingMobileNo" runat="server" Width="170px"
                                                                                    MaxLength="10"
                                                                                    onkeyup="valid(this)" onblur="valid(this)" placeholder="Mobile No."></asp:TextBox>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-4" style="vertical-align: top; border: .5px solid #D9EAED;">
                                                                                <asp:TextBox CssClass="form-control" ID="txtPlumbingFaxNo" runat="server" Width="170px"
                                                                                    MaxLength="11" onkeyup="valid(this)"
                                                                                    onblur="valid(this)" placeholder="Fax No."></asp:TextBox>
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center; vertical-align: top;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtPlumbingAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtOCVAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtRCVAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4" style="border: 1px solid #D9EAED; text-align: center;">
                                                                    <asp:TextBox CssClass="form-control" ID="txtECVAmendments" runat="server" Width="160px"
                                                                        onkeyup="valid(this)"
                                                                        onblur="valid(this)" Placeholder="Subsequent Amendments"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                ...
                                                <cc1:AccordionPane ID="AccordionPane2" runat="server">
                                                    <Header>
                                                        <a href="#" class="href">Availibility Of Documents (Y/N)</a>
                                                    </Header>
                                                    <Content>
                                                        <div class="row" style="width: 910px">
                                                            <div class="row">
                            ...
                            <div class="row">
                                 <div class="col-lg-12">
                                    <asp:Button CssClass="btn btn-primary" ID="btnParticularsCancel" runat="server" Text="Cancel"
