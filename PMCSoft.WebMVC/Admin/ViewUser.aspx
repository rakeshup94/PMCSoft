<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.Admin.ViewUser" Codebehind="ViewUser.aspx.cs" %>
                        ...
                        <div class="row"   >
                            ...
                            <div class="row" >
                                <div class="col-lg-4"  colspan="2">
                                    <asp:GridView CssClass="table table-striped"  ID="GridView1" runat="server" AutoGenerateColumns="false" Width="913px"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row"  style="width: 630px;">
                                                            ...
                                                            <div class="row" >
                                                                ...
                                                                <div class="col-lg-4" >
                                                                    <asp:TextBox CssClass="form-control" ID="txtEmail" runat="server" Text="" Value=""   Enabled="False"
