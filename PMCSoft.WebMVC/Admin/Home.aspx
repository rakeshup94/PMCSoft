                    ...
                    <div class="card-body">
                        ...
                        <asp:DataList ID="DataList1" runat="server" GridLines="Vertical" BorderStyle="None" 
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnAttachment" runat="server" Value='<%#Bind("FileName") %>'></asp:HiddenField>
                            </ItemTemplate>
                        </asp:DataList>
                ...
                <div class="col-lg-6">
                    <div class="card-body">
                        ...
                        <asp:Panel ID="Panel8" runat="server" ScrollBars="Both">
                            <asp:GridView CssClass="table table-hover table-striped table-bordered table-advanced tablesorter mbn"
                                ID="GvTotalLaber" runat="server" AllowPaging="True" AutoGenerateColumns="false">
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No">
                                        <ItemTemplate>
