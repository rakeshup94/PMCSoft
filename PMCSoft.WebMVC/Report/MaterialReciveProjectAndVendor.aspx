<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Inherits="PMCSoft.Web.Report.MaterialReciveProjectAndVendor" Codebehind="MaterialReciveProjectAndVendor.aspx.cs" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row"  style="width: 1090px;">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-lg-4" >
                                    <asp:Button btn btn-primary btn-square ID="BtnReport" runat="server" Text="View Detail" OnClick="BtnReport_Click" />
                                </div>
                            </div>
                            <div class="row" >
